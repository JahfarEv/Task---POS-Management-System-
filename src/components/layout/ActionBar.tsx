  ...
  return (
    <div className="bg-white border-t border-gray-300 p-2">
      ...
      <div className="grid grid-cols-6 gap-2 mb-2">
        ...
        <button className="bg-green-100 hover:bg-green-200 border border-green-300 rounded-lg flex flex-col items-center justify-center py-3 text-sm font-bold transition-all hover:shadow-md h-16">
          <Plus size={18} className="mb-1" /> QTY
        </button>
        <button
          onClick={clearCart}
          className="bg-red-100 hover:bg-red-200 border border-red-300 rounded-lg flex flex-col items-center justify-center py-3 text-sm font-bold text-red-800 transition-all hover:shadow-md h-16"
        >
      ...
      <div className="grid grid-cols-7 gap-2 mb-2">
        <button className="bg-gray-100 hover:bg-gray-200 border border-gray-300 rounded-lg flex items-center justify-center py-3 text-xs font-bold transition-all h-16">
        ...
        <button className="bg-red-100 hover:bg-red-200 border border-red-300 rounded-lg flex items-center justify-center py-3 text-xs font-bold text-red-800 transition-all h-16">
      ...
      <div className="grid grid-cols-7 gap-2">
        ...
        {/* Item */}
        <button className="bg-amber-100 hover:bg-amber-200 border border-amber-300 rounded-lg flex items-center justify-center py-3 text-xs font-bold transition-all h-16">
